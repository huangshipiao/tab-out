/* ================================================================
   Tab Out — Dashboard App (Cross-Browser Extension Edition)

   This file is the brain of the dashboard. Now that the dashboard
   IS the extension page (not inside an iframe), it can call
   browserApi.tabs and browserApi.storage directly — no postMessage bridge needed.

   Uses browserApi (defined in lib/browser-polyfill.js) for cross-browser
   compatibility with Chrome, Edge, and Firefox.

   What this file does:
   1. Reads open browser tabs directly via browserApi.tabs.query()
   2. Groups tabs by domain with a landing pages category
   3. Renders domain cards, banners, and stats
   4. Handles all user actions (close tabs, save for later, focus tab)
   5. Stores "Saved for Later" tabs in browserApi.storage.local (no server)
   ================================================================ */
...
/* ----------------------------------------------------------------
   ...
   access to browserApi.tabs and browserApi.storage. No middleman needed.
   ---------------------------------------------------------------- */
...
async function fetchOpenTabs() {
  try {
    // Use browserApi.runtime.getURL() for cross-browser URL protocol:
    //   Chrome/Edge → chrome-extension://{id}/index.html
    //   Firefox     → moz-extension://{id}/index.html
...
/* ----------------------------------------------------------------
   SAVED FOR LATER — browserApi.storage.local

   Replaces the old server-side SQLite + REST API with the browser's
   built-in key-value storage. Data persists across browser sessions
   and doesn't require a running server.

   Works identically across Chrome, Edge, and Firefox.
 ...
 * 2. Fetches open tabs via browserApi.tabs.query()
